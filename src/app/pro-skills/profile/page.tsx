...
import ChangePasswordForm from "@/app/trainer/profile/ChangePasswordForm";
import EmailChangeForm from "@/app/trainer/profile/EmailChangeForm";

export default async function ProSkillsProfilePage() {
    ...
    <div className="max-w-xl space-y-6 p-4 md:p-8">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-3">
        ...
        <div className="space-y-2">
          ...
          <Row label="Role"   value="Pro Skills Instructor" />
          <Row
            label="Status"
