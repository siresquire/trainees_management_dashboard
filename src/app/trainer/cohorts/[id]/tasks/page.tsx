  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div className="flex items-center gap-4">
        ...
        {(tasks?.length ?? 0) > 0 && (
          <a
            href={`/api/cohorts/${id}/tasks/export`}
            className="inline-flex items-center gap-1.5 text-xs font-medium text-slate-600 border border-slate-300 rounded-lg px-3 py-1.5 hover:bg-slate-50 transition-colors"
          >
