...
export type NavIconName =
  | "grid" | "users" | "shield" | "home" | "book" | "quiz" | "chart" | "settings" | "ticket";
...
function NavIcon({ name, active, isDark }: { name: NavIconName; active: boolean; isDark: boolean }) {
  ...
  if (name === "ticket")   return <svg className={cls} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path {...s} d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" /></svg>;
