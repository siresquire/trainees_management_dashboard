-- 1. Add voucher_code to the existing vouchers table
alter table vouchers
  add column if not exists voucher_code text;

-- 2. Voucher pool — pre-uploaded codes that are not yet visible to trainees
...
-- RLS: trainers / quiz_creators / super_admins manage the pool; trainees have no access
